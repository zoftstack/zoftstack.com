(function ($) {
    ...
    $(".portfolio-slider-area").owlCarousel({
        ...
        dots: false,
        margin: 10,
        responsive: {0: {items: 1,}, 768: {items: 2,}, 992: {items: 3,}, 1200: {items: 4,}, 1400: {items: 5,},}
    });
    ...
    $(".partner-slider-area").owlCarousel({
        ...
        responsive: {
            0: {items: 2, margin: 20,},
            576: {items: 3, margin: 70,},
            992: {items: 4, margin: 100,},
            1200: {items: 5, margin: 100,},
        }
    });
    ...
    $(".testimonial-slider-area-3").owlCarousel({
        ...
        loop: true,
        dots: false,
        responsive: {0: {items: 1,}, 992: {items: 2,}, 1200: {items: 1.5,}, 1400: {items: 2,}, 1550: {items: 2.4,},}
    });
